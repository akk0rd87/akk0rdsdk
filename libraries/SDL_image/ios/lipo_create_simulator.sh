...
xcodebuild -project ../SDL_Image/Xcode-iOS/SDL_image.xcodeproj -target libSDL_image-iOS -configuration Release -sdk iphonesimulator HEADER_SEARCH_PATHS=../../../SDL/SDL/include
...
cp ../SDL_Image/Xcode-iOS/build/Release-iphonesimulator/libSDL2_image.a libSDL2_image.a
