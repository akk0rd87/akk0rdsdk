...
{
    SDL_LogVerbose(SDL_LOG_CATEGORY_APPLICATION, "%s", "nativeSetupJNI()");
...
{
    SDL_LogVerbose(SDL_LOG_CATEGORY_APPLICATION, "%s", "AUDIO nativeSetupJNI()");
...
{
    SDL_LogVerbose(SDL_LOG_CATEGORY_APPLICATION, "%s", "CONTROLLER nativeSetupJNI()");
...
JNIEXPORT int JNICALL SDL_JAVA_INTERFACE(nativeRunMain)(JNIEnv* env, jclass cls, jstring library, jstring function, jobject array)
{
    ...
    SDL_LogVerbose(SDL_LOG_CATEGORY_APPLICATION, "%s", "nativeRunMain()");
...
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativePause)(
                                    JNIEnv* env, jclass cls)
{
    SDL_LogVerbose(SDL_LOG_CATEGORY_APPLICATION, "%s", "nativePause()");
...
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(nativeResume)(
                                    JNIEnv* env, jclass cls)
{
    SDL_LogVerbose(SDL_LOG_CATEGORY_APPLICATION, "%s", "nativeResume()");
...
int Android_JNI_OpenAudioDevice(int iscapture, int sampleRate, int is16Bit, int channelCount, int desiredBufferFrames)
{
    ...
    if (iscapture) {
        SDL_LogVerbose(SDL_LOG_CATEGORY_APPLICATION, "%s", "SDL audio: opening device for capture");
        ...
        SDL_LogVerbose(SDL_LOG_CATEGORY_APPLICATION, "%s", "SDL audio: opening device for output");
