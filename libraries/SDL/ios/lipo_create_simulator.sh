...
xcodebuild -project ../SDL/Xcode/SDL/SDL.xcodeproj -target "Static Library-iOS" -configuration Release -sdk iphonesimulator
#lipo -create ../SDL/Xcode/SDL/build/Release-iphoneos/libSDL2.a ../SDL/Xcode/SDL/build/Release-iphonesimulator/libSDL2.a -output libSDL2.a
#cp ../SDL/Xcode/SDL/build/Release-iphoneos/libSDL2.a libSDL2.a
cp ../SDL/Xcode/SDL/build/Release-iphonesimulator/libSDL2.a libSDL2.a