...
// Макросы дебага
#if defined(__AKK0RD_SDK_DEBUG_FORCE__) || defined(_DEBUG) && defined(SDL_PLATFORM_WINDOWS) || defined(SDL_PLATFORM_ANDROID) && !defined(NDEBUG) || defined(SDL_PLATFORM_APPLE) && defined(__DEBUG__) || defined(__CODEBLOCKS)
