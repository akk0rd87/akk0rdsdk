...
public:
	...
	bool LoadFromMemory(const char* Buffer, int Size, TextureType Type, const BWrapper::FileSearchPriority SearchPriority = BWrapper::FileSearchPriority::Assets, float Scale = 1.0f);
